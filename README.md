...
| Dev | Tarefa                                                      | Dependência           |
|-----|-------------------------------------------------------------|-----------------------|
|     | Criar página home do cliente (Next.js)                      | -                     |
|     | Criar formulário de pedido e integração com o backend       | D1                    |
|     | Desenvolver página de produto individual + seção de avaliação | D1                    |
|     | Implementar carrinho de compras                             | D1                    |
|     | Criar visualização de dados (gráficos e status do pedido)   | -                     |
|     | Testes manuais e ajustes                                    | Todos                 |

...
// import toast from 'react-hot-toast'; // REMOVIDO: Usaremos o componente Notification via a função 'show'
...
      return;
    }
    // Essas linhas de console.log não são necessárias no código final
    // console.log( typeof intervalo.inicio) 
    // console.log(intervalo.fim.length )
    // console.log( isMasterInterval && intervalo.inicio && intervalo.inicio.length === 5 && intervalo.fim && intervalo.fim.length === 5 && intervalo.inicio < intervalo.fim && duracao > 0)
    
